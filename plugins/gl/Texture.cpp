...
*/
	...
	Texture2d::Texture2d(bool multisampled, int numSamples)
		: Attribute(),
	...
	void Texture2d::bindAsUniform( int index )
	{
		int g_nextTextureUnit = 0;
		glActiveTexture(GL_TEXTURE0+g_nextTextureUnit);
		glBindTexture(m_target, m_id);
		glUniform1i( index, g_nextTextureUnit);
	}

	void Texture2d::unbindAsUniform( int index )
	{
	}

	Texture2d::Ptr Texture2d::create( int textureFormat, bool multisampled, int numSamples )
	{
		Texture2d::Ptr result = std::make_shared<Texture2d>(multisampled, numSamples);
	...
	Texture2d::Ptr Texture2d::createFloat32()
	{
		return Texture2d::create( GL_R32F );
	}
	...
	Texture2d::Ptr Texture2d::createRGBA8()
	{
		return Texture2d::create( GL_RGBA8 );
	}
	...
	// reference  texture
	Texture2d::Ptr Texture2d::createUVRefTexture()
	{
		Texture2d::Ptr tex = Texture2d::createRGBA8();
		int res = 256;
		unsigned char* pixels = (unsigned char*) malloc( res*res*sizeof(unsigned char)*4 );
		...
		tex->uploadRGBA8( res, res, pixels );
...
/*
	...
	{
		return Texture3d::create( GL_RGBA32F_ARB, xres, yres, zres );
	}
