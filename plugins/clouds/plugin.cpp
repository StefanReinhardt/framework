...
struct CloudsPlugin : public core::Plugin
{
	CloudsPlugin( core::Core::Ptr core )
	{
		...
		// 3D
		core->addDataFactory( core::DataFactoryT<Advect>::create(Advect::staticMetaObject.className(),"advects name identified field in 2d given a name identified velocity ") );
